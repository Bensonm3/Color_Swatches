...
const selectedIndex = document.getElementsByClassName("indexList");
...
// Loads initial swatch page on load
$(document).ready(generateswatchHtml());
// Generates initial swatch container display, checks for page index in displaying colors
...
// Checks to see if the entered text is a valid color, if not the user gets an error message
...
// Generates the clear button in the detail view
...
//  Function used to gather shades for Detail view, uses luminosity variations from main color to generate shades. Also creates a shades array to sort out duplicate shades
...
// Handles Random Color Button Click, selecting a random color from the colorList array to display
